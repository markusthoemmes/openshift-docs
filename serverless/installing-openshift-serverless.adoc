...
[NOTE]
====
On Openshift 4.1 you'll need to install the Service Mesh operator manually. Follow the respective
xref:../service_mesh/service_mesh_install/installing-ossm.adoc[documentation] to install the operator only.
====
